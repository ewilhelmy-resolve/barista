    ...
    <div className="branding-page">
      ...
      <Segment id="identity">
        ...
        <div className="section-row">
          ...
          <div className="section-preview">
            <Header as="h5" className="preview-label">Login View</Header>
        ...
        <div className="section-row">
          <div className="section-form">
            <Form>
              ...
              <Header as="h4">Modern Barista Theme</Header>
              <Form.Field>
                <Radio
          ...
          <div className="section-preview">
            <Header as="h5" className="preview-label">Application View</Header>
            ...
            <Header as="h5" className="preview-label">Modern Barista View</Header>
            <Segment className="preview-card" style={{ padding: 0, overflow: 'hidden' }}>
      ...
      <Segment id="bot">
        ...
        <div className="section-row">
          ...
          <div className="section-preview">
            <Header as="h5" className="preview-label">Chat View</Header>
            <Segment className="preview-card">
            ...
            <Header as="h5" className="preview-label">Bot Icon Safe Area</Header>
            <Segment className="preview-card">
              <p className="field-hint" style={{ marginBottom: 12 }}>
                512px grid, 64px gutter. Icon should not extend into the red area.
              </p>
            ...
            <Header as="h5" className="preview-label">Widget Icon</Header>
